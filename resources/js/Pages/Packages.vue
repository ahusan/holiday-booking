<template>
    <authenticated-layout>
        <div class="p-6 bg-white max-w-7xl mx-auto rounded-lg mt-2">
            <h1 class="text-3xl font-bold mb-6">Available Packages</h1>
            <div v-if="packages.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div v-for="item in packages" :key="item.id" class="bg-white shadow-md rounded-lg overflow-hidden">
                    <img :src="item.image_url" alt="Package Image" class="w-full h-96 object-cover z-0" />
        ...
        <Drawer :show="showModal" :title="packageDetails.title" @close="closeModal">
            <div class="w-full mx-auto">
                <img :src="packageDetails.image_url" alt="Package Image" class="w-full h-64 object-cover rounded-md" />
                ...
                <div class="mt-6">
                    ...
                    <ul class="list-disc list-inside text-gray-800">
                        <li v-for="(inclusion, index) in packageDetails.inclusions" :key="index">{{ inclusion }}</li>
                    </ul>
                </div>
                ...
                <div class="mt-6">
                    ...
                    <ul class="list-disc list-inside text-gray-800">
                        <li v-for="(exclusion, index) in packageDetails.exclusions" :key="index">{{ exclusion }}</li>
                    </ul>
                </div>
                ...
                <div class="mt-6">
                    ...
                    <ul class="list-disc list-inside text-gray-800">
                        <li v-for="(detail, day) in packageDetails.itinerary" :key="day">{{ day }}: {{ detail }}</li>
                    </ul>
                </div>
            ...
            <form>
                <div class="flex flex-col items-center w-full rounded-2xl shadow-2xl p-2">
                    ...
                    <div class="flex items-center">
                        <label class="block text-sm font-medium leading-6 text-gray-900" for="email">Date</label>
